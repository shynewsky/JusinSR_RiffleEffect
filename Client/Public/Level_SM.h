...
class CLevel_SM final : public CLevel
{
private:
	CLevel_SM(LPDIRECT3DDEVICE9 pGraphic_Device);
	virtual ~CLevel_SM() = default;
...
public:
	static CLevel_SM* Create(LPDIRECT3DDEVICE9 pGraphic_Device);
