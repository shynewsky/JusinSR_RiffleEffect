...
{
protected:
	CWeaponLight(LPDIRECT3DDEVICE9 pGraphic_Device);
	CWeaponLight(const CWeaponLight& Prototype);
	virtual ~CWeaponLight() = default;
...
public:
	static CWeaponLight* Create(LPDIRECT3DDEVICE9 pGraphic_Device);
