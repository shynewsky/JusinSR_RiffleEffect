...
class CLevel_Chaos final : public CLevel
{
private:
	CLevel_Chaos(LPDIRECT3DDEVICE9 pGraphic_Device);
	virtual ~CLevel_Chaos() = default;
...
public:
	static CLevel_Chaos* Create(LPDIRECT3DDEVICE9 pGraphic_Device);
