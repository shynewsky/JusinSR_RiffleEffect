...
CStone_Stand::CStone_Stand(LPDIRECT3DDEVICE9 pGraphic_Device)
	:CBlendObject{ pGraphic_Device }
{
}

CStone_Stand::CStone_Stand(const CBlendObject& Prototype)
	:CBlendObject{ Prototype }
{
}

HRESULT CStone_Stand::Initialize_Prototype()
{
	return S_OK;
}

HRESULT CStone_Stand::Initialize(void* pArg)
{
...
void CStone_Stand::Priority_Update(_float fTimeDelta)
{
}

int CStone_Stand::Update(_float fTimeDelta)
{
	if (m_bDead)
	{
#pragma region 테스트코드
...
#pragma endregion
	...
	{
		m_pTransformCom->Go_PosDir(fTimeDelta /* * 10.f*/, m_vDIr);
	}
...
void CStone_Stand::Late_Update(_float fTimeDelta)
{
...
HRESULT CStone_Stand::Ready_Components()
{
	/* For.Com_Texture */
	if (FAILED(__super::Add_Component(LEVEL_NERO, TEXT("Prototype_Component_Texture_Stone_Stand"),
...
HRESULT CStone_Stand::SetUp_RenderState()
{
...
HRESULT CStone_Stand::Reset_RenderState()
{
...
CStone_Stand* CStone_Stand::Create(LPDIRECT3DDEVICE9 pGraphic_Device)
{
	CStone_Stand* pInstance = new CStone_Stand(pGraphic_Device);

	if (FAILED(pInstance->Initialize_Prototype()))
	{
		MSG_BOX(TEXT("Failed to Created : CStone_Stand"));
...
CGameObject* CStone_Stand::Clone(void* pArg)
{
	CStone_Stand* pInstance = new CStone_Stand(*this);
