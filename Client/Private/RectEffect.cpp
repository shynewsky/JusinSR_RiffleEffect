...
CRectEffect::CRectEffect(LPDIRECT3DDEVICE9 pGraphic_Device)
	: CGameObject { pGraphic_Device }
{
}

CRectEffect::CRectEffect(const CRectEffect & Prototype)
	: CGameObject { Prototype }
{
}


HRESULT CRectEffect::Initialize_Prototype()
{
	return S_OK;
}

HRESULT CRectEffect::Initialize(void * pArg)
{
...
void CRectEffect::Priority_Update(_float fTimeDelta)
{
}

int CRectEffect::Update(_float fTimeDelta)
{
	if (m_bDead)
		return OBJ_DEAD;
...
void CRectEffect::Late_Update(_float fTimeDelta)
{
	m_fTime += fTimeDelta;
...
HRESULT CRectEffect::Ready_Components()
{
	/* For.Com_VIBuffer */
...
CRectEffect * CRectEffect::Create(LPDIRECT3DDEVICE9 pGraphic_Device)
{
	CRectEffect*		pInstance = new CRectEffect(pGraphic_Device);

	if (FAILED(pInstance->Initialize_Prototype()))
	{
		MSG_BOX(TEXT("Failed to Created : CRectEffect"));
