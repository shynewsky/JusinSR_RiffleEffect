...
CRound_Fence::CRound_Fence(LPDIRECT3DDEVICE9 pGraphic_Device)
	:CBlendObject{ pGraphic_Device }
{
}

CRound_Fence::CRound_Fence(const CBlendObject& Prototype)
	:CBlendObject{ Prototype }
{
}

HRESULT CRound_Fence::Initialize_Prototype()
{
	return S_OK;
}

HRESULT CRound_Fence::Initialize(void* pArg)
{
...
void CRound_Fence::Priority_Update(_float fTimeDelta)
{
}

int CRound_Fence::Update(_float fTimeDelta)
{
	if (m_bDead)
	{
#pragma region 테스트코드
...
void CRound_Fence::Late_Update(_float fTimeDelta)
{
...
HRESULT CRound_Fence::Ready_Components()
{
	/* For.Com_Texture */
	if (FAILED(__super::Add_Component(LEVEL_NERO, TEXT("Prototype_Component_Texture_Round_Fence"),
...
HRESULT CRound_Fence::SetUp_RenderState()
{
...
HRESULT CRound_Fence::Reset_RenderState()
{
...
CRound_Fence* CRound_Fence::Create(LPDIRECT3DDEVICE9 pGraphic_Device)
{
	CRound_Fence* pInstance = new CRound_Fence(pGraphic_Device);

	if (FAILED(pInstance->Initialize_Prototype()))
	{
		MSG_BOX(TEXT("Failed to Created : CRound_Fence"));
...
CGameObject* CRound_Fence::Clone(void* pArg)
{
	CRound_Fence* pInstance = new CRound_Fence(*this);
