...
public:
	COLLIDER_DESC Get_CollRectDesc() { return m_StateDesc; }
	void Set_CollRectDesc(COLLIDER_DESC& _desc) 
	{
		m_StateDesc.fRadiusX = _desc.fRadiusX; 
		m_StateDesc.fRadiusY = _desc.fRadiusY; 
		m_StateDesc.fRadiusZ = _desc.fRadiusZ; 
		m_StateDesc.fOffSetX = _desc.fOffSetX; 
		m_StateDesc.fOffSetY = _desc.fOffSetY; 
		//m_StateDesc.fOffsetZ = _desc.fOffSetZ;
	}
	_float3						m_vPoint[8];
